...
Decidimos priorizar la necesidad de conexión entre proyectos y colaboradores por roles sobre la necesidad de financiación. Consideramos que contar con las personas adecuadas y la validación comunitaria es un paso previo fundamental para que cualquier iniciativa pueda prosperar o solicitar recursos institucionales más adelante.
...
- ¿Qué factores motivan a un estudiante a unirse al proyecto de otra persona cuando no existe una retribución económica?
- ¿Qué nivel de detalle o estructura en la presentación de una idea es suficiente para despertar el interés de posibles colaboradores sin desanimar a quien la publica?
- ¿Cómo se pueden validar las habilidades o el compromiso de los colaboradores dentro de la comunidad?
